case $1 in
sqlite3)
  ./pharo Pharo.image eval --save "GAGlorpContinuousIntegrationConfiguration new configureSqlite3"
  ;;
mysql)
  ...
  ./pharo Pharo.image eval --save "GAGlorpContinuousIntegrationConfiguration new configureMysql"
  ;;
postgresV2)
  ...
  ./pharo Pharo.image eval --save "GAGlorpContinuousIntegrationConfiguration new configurePostgresql";
  ;;
*)
